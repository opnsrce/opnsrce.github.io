...
**Blue Collar Development:** Development that is done on a system, application, or platform that _is not_ the primary product being sold (e.g., an internal website used by an insurance agency for use by its agents).

<!--more-->

**White Collar Development:** Development that is done on a system, application, or platform that _is_ the primary product being sold (e.g., Facebook).
...
#### Blue Collar:
  ...
  * <span style="line-height: 13px;">You&#8217;re interested in learning more about the industry that you&#8217;re developing for than just the development itself.</span>
  * You&#8217;re contracting / freelancing.
  * You&#8217;re looking for long-term maintenance as opposed to launching new projects.

#### ****White Collar:

  * <span style="line-height: 13px;">You want to work in a fast-paced environment.</span>
